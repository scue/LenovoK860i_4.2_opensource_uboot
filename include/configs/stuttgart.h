...
#define CONFIG_CLK_BUS_DMC_200_400         /* both stuttgart 1.4G and 1.6G use this setting, depend on chip id*/
/* bus clock: 220Mhz, DMC clock 440Mhz */
//#define CONFIG_CLK_BUS_DMC_220_440  	
#endif
...
#define CONFIG_PM_VDD_INT	1.1  /* jeff, modify to fit 220M ASV0. Orig : 1.0 */
#define CONFIG_PM_VDD_G3D	1.1
#define CONFIG_PM_VDD_MIF	1.15 /* jeff, modify to fit 440M ASV0. Orig : 1.1 */
...
#else
#define CONFIG_NR_DRAM_BANKS	4       /* jeff, set both 2G and 1G ram 4 banks, */
#endif
...
//
#define SDRAM_BANK_SIZE_2G      0x20000000    /* 512 MB */
#define PHYS_SDRAM_1_2G         CONFIG_SYS_SDRAM_BASE /* SDRAM Bank #1 */
#define PHYS_SDRAM_1_SIZE_2G    SDRAM_BANK_SIZE_2G
#define PHYS_SDRAM_2_2G         (CONFIG_SYS_SDRAM_BASE + SDRAM_BANK_SIZE_2G) /* SDRAM Bank #2 */
#define PHYS_SDRAM_2_SIZE_2G    SDRAM_BANK_SIZE_2G
#define PHYS_SDRAM_3_2G         (CONFIG_SYS_SDRAM_BASE + 2 * SDRAM_BANK_SIZE_2G) /* SDRAM Bank #3 */
#define PHYS_SDRAM_3_SIZE_2G    SDRAM_BANK_SIZE_2G
#define PHYS_SDRAM_4_2G         (CONFIG_SYS_SDRAM_BASE + 3 * SDRAM_BANK_SIZE_2G) /* SDRAM Bank #4 */
#define PHYS_SDRAM_4_SIZE_2G    SDRAM_BANK_SIZE_2G
#define PHYS_SDRAM_5_2G         (CONFIG_SYS_SDRAM_BASE + 4 * SDRAM_BANK_SIZE_2G) /* SDRAM Bank #5 */
...
*/
/* Fastboot variables */
#define CFG_FASTBOOT_TRANSFER_BUFFER            (0x4e000000)
#define CFG_FASTBOOT_TRANSFER_BUFFER_SIZE       (0x32000000)   /* 800MB */

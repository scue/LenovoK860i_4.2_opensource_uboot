...
extern unsigned int is_exynos4412_rev20(void);
#endif
...
/* jeff, for stuttgart */
#ifdef CONFIG_EXYNOS4412
#define MAX_EMMC_CLOCK_4412_REV1 (52000000) /* max clock 50Mhz */
#define MAX_EMMC_CLOCK_4412_REV2 (40000000) /* max clock 40Mhz */
#endif
...
/* jeff, for stuttgart */
	...
	if(is_exynos4412_rev20())
		max_emmc_clock = MAX_EMMC_CLOCK_4412_REV2;
	else
		max_emmc_clock = MAX_EMMC_CLOCK_4412_REV1;
#endif	
